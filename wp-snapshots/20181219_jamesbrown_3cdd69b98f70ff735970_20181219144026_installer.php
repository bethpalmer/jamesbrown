...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181219_jamesbrown_3cdd69b98f70ff735970_20181219144026_archive.zip';
	const ARCHIVE_SIZE		 = '101408981';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3cdd69b-19144026';
	const VERSION			 = '1.3.0';
