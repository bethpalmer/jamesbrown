...
class InstagramFeedModule extends ET_Builder_Module
{
    ...
    protected function getConfigurationFields()
    {
        ...
        if ($this->is_pro) {
            $type_options = array_merge($type_options, array(
                'hashtag' => 'Hash Tag',
                'location' => 'Location',
        ...
        $fields['coordinates'] = array(
            ...
            'tab_slug' => 'general',
            'toggle_slug' => 'configuration_options',
            'description' => esc_html__('The coordinates to display photos from. Separate multiple sets of coordinates by commas.
The format is (latitude,longitude,distance). Only available in Pro version', 'et_builder'),
    ...
    public function render($atts, $content = null, $function_name)
    {
        ...
        $attributes['excludewords'] = isset($atts['excludewords']) ? $atts['excludewords'] : '';
        $attributes['includewords'] = isset($atts['includewords']) ? $atts['includewords'] : '';
